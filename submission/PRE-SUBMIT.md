...
- [x] First-cut reel (~76s TTS): [`demo-reel/stage-manager-demo.mp4`](demo-reel/stage-manager-demo.mp4) — reconstructed call, real CLI
- [ ] **Live take** (win shot): real CALL-E ring + stage code + “one” + Slack land
- [x] Stage code + line reading visible on reconstructed beat
- [x] Decision → action intent → Slack payload on screen
...
- [x] [`demo-reel/stage-manager-loop.gif`](demo-reel/stage-manager-loop.gif) on README + `site/assets/`
